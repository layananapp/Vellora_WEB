...
>
    ...
    >
        <div>
            ...
            <div class="flex items-center justify-between lg:justify-center">
                <h1 class="text-2xl font-bold text-pink-300">
                    Vellora
                </h1>
        ...
        <div class="mt-10 space-y-3">
            ...
            {{ request()->is('admin/dashboard') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/user*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/seller*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">

                <i class="ri-store-2-line text-xl"></i>

                <span>Seller/Toko</span>
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/produk*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/review*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/transaksi*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/notifikasi*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/laporan*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-full transition
            {{ request()->is('admin/pengaturan*') ? 'bg-pink-100 font-medium' : 'hover:bg-gray-100' }}">
    ...
    <div class="pt-6">
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full text-red-500 hover:bg-red-50 transition w-full border border-red-200">
    ...
    <template x-teleport="body">
        ...
        class="fixed inset-0 z-[999999] flex items-center justify-center">
            ...
            {{-- Modal --}}
            <div class="relative z-10 bg-[#F5F5F5] rounded-[35px] px-8 py-7 w-[320px] text-center shadow-xl">
